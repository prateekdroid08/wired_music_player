package com.avfplayer.videoMediaController;
...
public class VideoViewController extends FrameLayout implements VideoGestureListener {
    ...
    public VideoViewController(VideoViewController.Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder withVideoSurfaceView(@Nullable VideoView videoView){
        ...
        public VideoViewController build(@Nullable ViewGroup anchorView) {
            this.anchorView = anchorView;
            return new VideoViewController(this);
        }
    ...
    private static class ControllerViewHandler extends Handler {
        private final WeakReference<VideoViewController> mView;

        ControllerViewHandler(VideoViewController view) {
            mView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            VideoViewController view = mView.get();
    ...
    private void show() {
        ...
        if (!mIsShowing && mAnchorView != null) {
            ...
            mAnchorView.addView(VideoViewController.this, tlp);
    ...
    private void hide() {
        ...
        ViewAnimator.putOn(mTopLayout)
                ...
                .end(new ViewAnimator.Listeners.End() {
                    @Override
                    public void onEnd() {
                        mAnchorView.removeView(VideoViewController.this);
